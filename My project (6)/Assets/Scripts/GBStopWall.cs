...
public class GBStopWall : MonoBehaviour
{
   ...
   // public float PositionWall;
    ...
    {
        if (collision.tag == "Player1" && transform.position.y > HightButton)
        {
            transform.Translate(Vector2.down * Time.deltaTime);
        }
        else if (collision.tag == "Player1" && wall.transform.position.y < HightWall)
        {
